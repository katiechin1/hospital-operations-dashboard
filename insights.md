...
- Neurology (164 min) and General Surgery (160 min) have the longest waits, while Radiology (138 min) and Pediatrics (145 min) demonstrate efficient patient movement. These high-performing departments can be modeled for best practices.

- Peak patient volume occurs between 8 AM and 3 PM, especially on Mondays and Sundays, where both patient load and delays increase sharply. Performance improvements should focus on these windows.
